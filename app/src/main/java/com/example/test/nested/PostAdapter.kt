...
import com.example.test.MasterExoPlayerHelper
import com.example.test.Model
import com.example.test.R
import com.example.test.databinding.ItemBinding
import com.example.test.databinding.ItemImageBinding
import com.example.test.databinding.ItemNestedBinding
import com.example.test.databinding.NestedItemPlayerBinding
...
class PostAdapter(val list: ArrayList<Model>, val masterExoPlayerHelper: MasterExoPlayerHelper) : RecyclerView.Adapter<PostAdapter.MyViewHolder>() {
    ...
    class MultipleViewHolder(val binding: ItemNestedBinding) : MyViewHolder(binding.root) {
        val adapter:SimpleAdapter<Model> = TODO()
